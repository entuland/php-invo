...
Taken and adapted from https://github.com/mjackson/mjijackson.github.com/blob/master/2008/02/rgb-to-hsl-and-rgb-to-hsv-color-model-conversion-algorithms-in-javascript.txt

The above link doesn't work anymore, the closest source I can cite is this: https://gist.github.com/mjackson/5311256
...
*/
  ...
  /*
   * Taken and adapted from http://stackoverflow.com/a/5624139
   */
   ...
   * @returns {Object}    The resulting RGB components
   */
  ...
  /**
   * Converts single color component to hex
   * 
   * @param {Number} c  A component to convert to hex   
   * @returns String    The resulting hex string with a leading zero
   */
   ...
   * @returns {String}  The resulting hex string, with leading #
   */
